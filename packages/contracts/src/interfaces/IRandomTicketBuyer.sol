 ...
 *      (its buyTickets requires an explicit 5-number pick), so Squads buys quick-pick
 *      tickets through here and explicit-pick tickets through the Jackpot's buyTickets.
 ...
 *
 *      Copied verbatim from PennyPot (`andreitr/pennypot`).
 */
